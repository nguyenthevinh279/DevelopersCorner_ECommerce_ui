    ...
    <>
      <header className="header-top-strip py-3">
        <div className="container-xxl">
          <div className="row">
            <div className="col-6">
              <p className='text-white mb-0'>Free Shipping 0ver $100 & Free Return</p>
            </div>
            <div className="col-6">
              <p className='text-end text-white mb-0'>
                Hotline: 
                <a className='text-white' href="tel:+84 825903849">
                  0974367344</a>
              </p>
            </div>
          </div>
              ...
              <div className="menu-bottom d-flex align-items-center gap-30">
                <div>
                    ...
                    <img src="../images/menu.svg" alt="" />
                     <span className='me-5 d-inline-block'>Shop Caregories</span> 
                    </button>
